...
In this chart, we wanted to visualize the relationship between the housing prices of each borough and the physical size of the top 5 most popular dogs in each borough. Currently, the rank of housing prices in New York is 1. Manhattan, 2. Brooklyn, 3. Queens, 4. Staten Island, 5. Bronx. We created a bar chart for each of the five boroughs to easily compare the most popular dogs in each one.  

In Manhattan, the most popular dog was the Yorkshire Terrier, which is a small dog. This may imply that the high price of housing leads to owners preferring small size dogs because they don't require as much space as larger dogs. And in Bronx, their most popular dog breed was also the Yorkshire Terrier. We can also see that the top 5 dogs in both Manhattan and Bronx are very similar: there were four small dog breeds, and one large breed. Therefore, it's possible that housing prices do not influence the dog-size preference as much as we had originally inferred.  
